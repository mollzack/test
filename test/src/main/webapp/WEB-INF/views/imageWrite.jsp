...
.title{
	...
	<script>
	function check() {
		if(document.iw.title.value==""){
			alert("제목을 입력하세요");
			return false;
			
		}
		else if(document.iw.content.value==""){
			alert("내용을 입력하세요");
			return false;
		}else{
			document.iw.submit();
...
<div class="classrow">
    ...
    <div id="jayu"> 글쓰기 </div>
	 ...
	 <form name="iw" action="imageWrite.do" enctype="multipart/form-data" method="post">
	...
	<table border="1">
	 <tbody>
	 	...
	 	<input  type="file" name="upload_f2" ><br>  
	 	<input  type="file" name="upload_f3" ><br>  
	 	<input  type="file" name="upload_f4" ><br>    
	 	</td>
	 	</tr>
